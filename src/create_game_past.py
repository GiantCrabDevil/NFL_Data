...
URL = "https://www.pro-football-reference.com/years/2025/week_6.htm"
...
for box_link in box_links:
    ...
    home_line = float(favorite[1]) if favorite[0] == home_team_text else abs(float(favorite[1]))
    away_line = -home_line
    games_data.append((game_date_time, home_team, home_line,
                      away_team, away_line, over_under))

db_utils.Queries.insertGames(games_data)
driver.quit()
print("DONE!!")
